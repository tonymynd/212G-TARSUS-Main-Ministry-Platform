...
export function buildTarsusSystemPrompt(opts: {
  ...
  return [
    ...
    '4. Peace only comes by understanding: Philippians 4:7 has a backward CJ: Christ (peace) Jesus (understanding), indicating a reverse mode: peace → understanding, but in Jesus (innerstanding) → Christ (peace, as he is our peace) is the correct order.',
